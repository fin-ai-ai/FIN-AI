...
const Dashboard = () => {
  ...
  const fetchUserData = async () => {
    try {
      ...
      const portfolioResponse = await axios.get('http://localhost:5000/api/dashboard/portfolio', {
  ...
  return (
    <div className={`min-h-screen ${theme === 'dark' ? 'bg-purple-900 text-white' : 'bg-purple-50 text-[rgb(88,28,135)]'}`}>
      ...
      <header className="container mx-auto py-6 px-4 flex justify-between items-center">
        ...
        <nav>
          <ul className="flex space-x-6 font-montserrat items-center">
            ...
            <li>
              <button onClick={toggleTheme} className="p-2 rounded-full bg-gradient-to-r from-purple-600 to-pink-500 text-white">
